...
MODULES                 = MultirotorModel.c MultirotorModel_capi.c MultirotorModel_data.c MultirotorModel_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = MultirotorModel
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB_R2024b.app/bin/maca64 -Wl,-rpath,/Applications/MATLAB_R2024b.app/sys/os/maca64 -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB_R2024b.app/sys/os/maca64
INTERLEAVED_COMPLEX_FLAGS = -R2018a
DEFINES_CUSTOM          = -DEXT_MODE -DIS_RAPID_ACCEL -DRACCEL_ENABLE_PARALLEL_EXECUTION -DRACCEL_PARALLEL_EXECUTION_NUM_THREADS=10 -DRACCEL_NUM_PARALLEL_NODES=1 -DRACCEL_PARALLEL_SIMULATOR_TYPE=0 
DEFINES_OTHER           = -DHAVESTDIO
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2024b.app/bin/maca64" -lmwblas -lut -lmx -lmex -lmat -lmwmathutil -lmwslsa_engine -lmwslexec_simbridge -lmwsl_fileio -lmwsigstream -lmwsl_AsyncioQueue -lmwsl_services -lmwsdi_raccel -lmwcoder_target_services -lmwcoder_ParamTuningTgtAppSvc -lmwslpointerutil -lmwfoundation_i18n_init_c_api -lmwsl_simtarget_instrumentation -lmwslexec_parallel -lfixedpoint -lmwslexec_simlog -lmwstringutil -lm -lpthread -ldl
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/MultirotorModel \
