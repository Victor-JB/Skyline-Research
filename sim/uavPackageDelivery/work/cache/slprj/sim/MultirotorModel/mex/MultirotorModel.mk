...
MAKECMD         = /Applications/MATLAB_R2024b.app/bin/maca64/gmake -j 8 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODULES                 = MultirotorModel_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/MultirotorModel_msf.mexmaca64
MAKEFILE                = MultirotorModel.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/nikhilranjit/Documents/MATLAB/Examples/R2024b/uav/Skyline/uavPackageDelivery/work/cache
S_FUNCTIONS_LIB         = $(START_DIR)/slprj/sim/_sharedutils/rtwshared.a
NUMST                   = 5
NCSTATES                = 12
COMPUTER                = MACA64
BUILDARGS               =  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2024b.app/bin/maca64" -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lemlrt -lmx -lmex
...
MODELLIB                  = MultirotorModel_msf.mexmaca64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/MultirotorModel/MultirotorModellib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/MultirotorModel/MultirotorModellib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/MultirotorModel/MultirotorModellib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/MultirotorModel \
...
MultirotorModel_msf.o : $(START_DIR)/slprj/sim/MultirotorModel/MultirotorModel_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/MultirotorModel/MultirotorModel_msf.c
