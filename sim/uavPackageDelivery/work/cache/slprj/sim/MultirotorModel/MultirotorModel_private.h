...
#define rtmGetClockTick3(rtm) ssGetClockTick( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[3])
#endif
#ifndef rtmGetClockTick4
#define rtmGetClockTick4(rtm) ssGetClockTick( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[4])
#endif
#ifndef rtmGetClockTick5
#define rtmGetClockTick5(rtm) ssGetClockTick( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[5])
#endif
...
#define rtmGetClockTickH3(rtm) ssGetClockTickH( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[3])
#endif
#ifndef rtmGetClockTickH4
#define rtmGetClockTickH4(rtm) ssGetClockTickH( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[4])
#endif
#ifndef rtmGetClockTickH5
#define rtmGetClockTickH5(rtm) ssGetClockTickH( _ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[5])
#endif
...
#define rtmGetVarNextHitTime(rtm, sti) (_ssGetVarNextHitTime((rtm)->_mdlRefSfcnS,  (int)(ssGetOffsetTime(_ssGetRootSS((rtm)->_mdlRefSfcnS), (rtm)->Timing.mdlref_GlobalTID[sti+5]))))
#endif
#ifndef rtmSetVarNextHitTime
#define rtmSetVarNextHitTime(rtm, sti, val) ssSetTimeOfNextVarHit((rtm)->_mdlRefSfcnS,  (rtm)->Timing.mdlref_GlobalTID[sti], val)
#endif
extern iiy2tsharng iiy2tsharn ; void InitCalcAtmosCOESA ( real_T *
temperature76 , real_T * pressureRatio76 ) ; void CalcAtmosCOESA ( const
real_T * altitude , real_T * temp , real_T * pressure , real_T * density ,
real_T * speedofsound , real_T * temperature76 , real_T * pressureRatio76 ,
int_T numPoints ) ;
#endif
