...
MODEL                   = rtwshared
MODULES                 = CalcAtmosCOESA.c InitCalcAtmosCOESA.c rtGetNaN.c rt_TDelayInterpolate.c rt_mrdivide_U1d1x3_U2d3x3_Yd1x3_snf.c rt_nonfinite.c
PRODUCT                 = rtwshared.a
MAKEFILE                = 
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  OPTS="-DNRT -DIS_SIM_TARGET" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=12.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
